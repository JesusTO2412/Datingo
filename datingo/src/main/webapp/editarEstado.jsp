<%-- 
    Document   : editarEstado.jsp
    Created on : 6 jul. 2020, 8:28:45
    Author     : Jesus
--%>
      ...
      <div class="row">
        <nav class="col-sm-3 col-md-2 d-none d-sm-block sidebar fixed-left bg-dark">
          ...
          <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="editarEstado.jsp">Editar Estado</a>
            </li>
            <li class="nav-item">
          ...
          <div class="card">
            <div class="card-body">
              <form action="#" method="post" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn btn-success"><i class="fas fa-pen"></i> Editar Estado</button>   
              </form>
            </div>
          </div>
        </main>
