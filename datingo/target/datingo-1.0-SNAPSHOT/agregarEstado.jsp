<%-- 
    Document   : agregarEstado.jsp
    Created on : 6 jul. 2020, 8:26:29
    Author     : Jesus
--%>
      ...
      <div class="row">
        <nav class="col-sm-3 col-md-2 d-none d-sm-block sidebar fixed-left bg-dark">
          ...
          <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="agregarEstado.jsp">Insertar Estado</a>
            </li>
            <li class="nav-item">
              ...
              <form action="#" method="post" enctype="multipart/form-data">
                <div class="form-row">
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" required="" name="nombreEstado">
                  </div>
                </div><br>
                <button type="reset" class="btn btn-danger"><i class="fas fa-trash-alt"></i> Limpiar datos</button>
                <button type="submit" class="btn btn-success"><i class="fas fa-plus"></i> Insertar Estado</button>   
              </form>
            </div>
          </div>
        </main>
