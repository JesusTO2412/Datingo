      ...
      <div class="row">
        <nav class="col-sm-3 col-md-2 d-none d-sm-block sidebar fixed-left bg-dark">
          ...
          <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="editarUsuario.jsp">Editar Usuario</a>
            </li>
            <li class="nav-item">
              ...
              <form action="#" method="post" enctype="multipart/form-data">
                <div class="form-row">
                  <div class="form-group col-md-4">
                    ...
                    <input type="password" class="form-control" required="" name="contraActual">
                  </div>
                  <div class="form-group col-md-4">
                    <label>Contraseña Nueva</label>
                    <input type="password" class="form-control" required="" name="nuevaContra">
                  </div>
                  <div class="form-group col-md-4">
                    <label>Confirmar Contraseña</label>
                    <input type="password" class="form-control" required="" name="confirmarContra">
                  </div>
                </div><br>
                <button type="reset" class="btn btn-danger"><i class="fas fa-trash-alt"></i> Limpiar datos</button>
                <button type="submit" class="btn btn-success"><i class="fas fa-key"></i> Editar Contraseña</button>           
              </form>
            </div>
          </div>
        </main>
